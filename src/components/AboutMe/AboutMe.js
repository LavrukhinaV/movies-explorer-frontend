    ...
    <section className="section section_about-me">
      ...
      <article className="about-me">
        ...
        <p className="about-me__info">
          Я родилась на Алтае, сейчас живу в Московской области. Люблю собак, кататься на сноуборде и путешствовать. 
          На протяжении пяти лет работаю техническим специалистом. В прошлом году решила осуществить свою мечту и начала учебу в Практикуме на курсе веб-разработки.
        </p>
